...
SDL_Texture* convert_image_to_texture(SDL_Renderer* renderer, SDL_Surface* image ){
  // convert to texture
...
int main(int argc, char** argv)
{
  ...
  // Create window
  SDL_Window* window = SDL_CreateWindow( "Devil's Hour", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN );
  ...
  SDL_Rect dst = { (SCREEN_WIDTH - 256) / 2, (SCREEN_HEIGHT - 256) / 2, 256, 256};
